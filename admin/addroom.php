        ...
        <div class="well">
            ...
            <form action="" method="post" name="room_category">
                <div class="form-group">
                    <label for="roomname">Storage Name:</label>
                    <input type="text" class="form-control" name="roomname" placeholder="Grain store name" required>
                </div>
                
                <div class="form-group">
                    <label for="bed">No of silo stores:</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <select name="no_bed">
